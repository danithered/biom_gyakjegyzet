...
Alap esetben a képletet nekünk kell beírnunk, de a félév során mutatunk majd más módszert is, hogyan lehet kinyerni az adatokból a konfidenciaintervallumot
...
ELSŐDLEGES kérdés: Ismerjük-e a populáció átlagok szórását meghatározó paramétert?  
  ...
  1. Doctor Strange ismeri $\sigma=3$ --> $SE= {\sigma} / { \sqrt{n} }$
